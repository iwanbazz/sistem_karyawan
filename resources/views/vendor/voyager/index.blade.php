...
@section('content')
    <div class="page-content">
        ...
        <img src="/image/logo.png" style="display: block; margin-left: auto; margin-right: auto;">
        <div style="padding: 2%">
            <div style="float: left; width: 33.33%; padding:5px;">
                <img src="/image/dc286.png" style="width:100%">
            </div>
            <div style="float: left; width: 33.33%; padding:5px;">
                <img src="/image/canon.png" style="width:100%">
            </div>
            <div style="float: left; width: 33.33%; padding:5px;">
                <img src="/image/ap.png" style="width:100%">
            </div>
        </div>
